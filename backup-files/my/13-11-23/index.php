  ...
  <div class="auto-container">
    ...
    <div class="container">
      ...
      <div class="row justify-content-center">
        ...
        <div class="col-12 col-lg-4 col-md-4">
          <div class="sponsors-outer">
            <h3 style="background: linear-gradient(45deg, #FF5733, #FFC300)" class="w-100 text-center">Dinner & Cocktail Sponsor</h3>
            <div>
              <!-- Client Block -->
              <div class="client-block ">
                <figure class="image-box">
      ...
      <div class="row justify-content-center">
        <div class="col-12">
          <div class="sponsors-outer">
            <h3 style="background-color: #1d95d2; margin-bottom: 40px;" class="w-100 text-center">Lunch & Coffee Sponsors</h3>
            <div class="row justify-content-center">
              <div class="col-12 col-lg-4 col-md-6">
                <div class="client-block">
                  <figure class="image-box">
                    <a href="javascript:void(0);"><img src="pics/lunch-and-coffe/ruby.webp" alt="Lunch & Coffee Sponsor" /></a>
                  </figure>
                </div>
              </div>
              <div class="col-12 col-lg-4 col-md-6">
      ...
      <div class="row justify-content-center">
        ...
        <div class="col-12 col-lg-4 col-md-4">
          <div class="sponsors-outer">
            <h3 style="background: linear-gradient(to right, #32CD32, #9FE2BF)" class="w-100 text-center">Conference Session Sponsor</h3>
            <div>
              <!-- Client Block -->
              <div class="client-block ">
                <figure class="image-box">
