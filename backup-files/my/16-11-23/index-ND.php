  ...
  <div class="auto-container">
    ...
    <div class="container">
      ...
      <div class="row justify-content-center">
        ...
        <div class="col-12 col-lg-4 col-md-4">
          <div class="sponsors-outer">
            <h3 style="background: #1d95d2" class="w-100 text-center">Dinner & Cocktail Sponsor</h3>
            <div>
              <!-- Client Block -->
              <div class="client-block ">
                <figure class="image-box">
      ...
      <div class="row justify-content-center">
        ...
        <div class="col-12 col-lg-4 col-md-4">
          <div class="sponsors-outer">
            <h3 style="background: #1d95d2" class="w-100 text-center">Conference Session Sponsor</h3>
            <div>
              <!-- Client Block -->
              <div class="client-block ">
                <figure class="image-box">
