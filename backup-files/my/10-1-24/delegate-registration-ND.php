          ...
          <div class="container pb-5 pt-5">
            ...
            <form action="delegate-reg-action.php" id="registration" method="POST">
              <div class="row justify-content-center">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 p-3">
                  <input class="border w-100 inp form-control" type="email" name="official_email" id="official_email" placeholder="Official Mail" required />
                </div>
                <!-- <div class="col-lg-4 col-md-6 col-sm-12 p-3">
...
<script type="text/javascript">
  var validate = $("#registration").validate({
    ...
    messages: {
      ...
      official_email: "Please enter a valid email address.",
