            ...
            <div class="tabs-content">
                ...
                <div class="tab active-tab" id="tab-1">
                    <div class="schedule-timeline">
                        ...
                        <h5 style="text-align: center;color: #1e1f36;font-family: Ubuntu;font-weight: 600;" class="mb-3">
                            ...
                            <div class="inner-box">
                                <div class="inner">
                                    ...
                                    <div class="speaker-info mb-2">
                                        ...
                                        <h5 class="name">
                                            LEADERSHIP INSIGHTS : Session with Mr. Emanuele Grimaldi
                                        </h5>
                                        <span class="designation">
                        ...
                        <h5 style="text-align: center;color: #1e1f36;font-family: Ubuntu;font-weight: 600;" class="mb-3">Conference 2nd Session</h5>
                        ...
                        <!--  -->
                        <h5 style="text-align: center;color: #1e1f36;font-family: Ubuntu;font-weight: 600;" class="mb-3">Conference 3rd Session</h5>
                            ...
                            <div class="inner-box">
                                <div class="inner">
                                    ...
                                    <div class="speaker-info">
                                        ...
                                        <span class="designation">
                                            Technical Manager, Lenol Marine DMCC
                                        </span>
                                    </div>
