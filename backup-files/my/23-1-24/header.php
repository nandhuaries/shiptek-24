...
<head>
    ...
    if ($pagename == "agenda.php") { ?>
        <title>Event Schedule | ShipTek 2024 - Dubai</title>
        <meta property="og:title" content="Event Schedule | ShipTek 2024 - Dubai" />
        <meta property="og:url" content="https://www.shiptekmaritimeevents.com/shiptek-2024/agenda">
    ...
    <?php $evt_date = "24th - 25th January 2024" ?>
    <?php $evt_loc = "JW MARRIOTT HOTEL MARINA, DUBAI (Formerly known as Address Marina Hotel)" ?>
</head>
                        ...
                        <nav class="main-menu navbar-expand-md navbar-light">
                            ...
                            <div class="collapse navbar-collapse clearfix" id="navbarSupportedContent">
                                <ul class="navigation clearfix">
                                    ...
                                    <!-- <li style="background-color: #faaf25;" class="blink rounded">
                                        <a href="index#agenda">Agenda</a>

                                    </li> -->

                                    <a href="index#agenda" class="theme-btn btn-style-one blink ml-2"><span class="btn-title">Agenda</span></a>
