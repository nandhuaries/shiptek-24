        ...
        <div class="row">
            ...
            <div class="speaker-block col-lg-3 col-md-6 col-sm-12">
                <div class="inner-box">
                    <div class="image-box">
                        <figure class="image">
                            <a href="Javascript: void(0)"><img src="pics/2024-speakers/Capt-Saif-Al-Mheiri.jpg" alt="" /></a>
                        </figure>
                    </div>
                    <div class="info-box">
                        <div class="inner">
                            <h4 class="name">
                                <a href="Javascript: void(0)">Captain Saif AL Mheiri</a>
                            </h4>
                            <span class="designation">Managing Director , Abu Dhabi Maritime</span>
...
<span class="designation">Technical Manager , Lenol DMCC</span>
 <div class="social-box">
<button data-toggle="modal" data-target="#Nikolaos" class="btn btn-primary">
View More</button>
</div> 
            ...
            <div class="speaker-block col-lg-3 col-md-6 col-sm-12">
                <div class="inner-box">
                    <div class="image-box">
                        <figure class="image">
                            <a href="Javascript: void(0)"><img src="pics/2024-speakers/tobias-giese.jpg" alt="" /></a>
                        </figure>
                    </div>
                    ...
                    <div class="info-box">
                        <div class="inner">
                            <h4 class="name">
                                <a href="Javascript: void(0)">Tobias Giese</a>
                            </h4>
                            <span class="designation"> Technical Manager<br> LENOL DMCC</span>
                            <div class="social-box">
                                <button data-toggle="modal" data-target="#tobias" class="btn btn-primary">
                                    View More</button>
                            </div>
            ...
            <div class="speaker-block col-lg-3 col-md-6 col-sm-12">
                <div class="inner-box">
                    <div class="image-box">
                        <figure class="image">
                            <a href="Javascript: void(0)"><img src="pics/2024-speakers/nitin-mehta.jpg" alt="" /></a>
                        </figure>
                    </div>
                    <div class="info-box">
                        <div class="inner">
                            <h4 class="name">
                                <a href="Javascript: void(0)">Nitin Mehta</a>
                            </h4>
                            <span class="designation">
                                COO & Head of Strategy, Lila Global (GMS Group)
                            </span>
                            <div class="social-box">
                                <button data-toggle="modal" data-target="#Nitin" class="btn btn-primary">View More</button>
                            </div>
            ...
            <div class="speaker-block col-lg-3 col-md-6 col-sm-12">
                <div class="inner-box">
                    <div class="image-box">
                        <figure class="image">
                            <a href="Javascript: void(0)"><img src="pics/2024-speakers/Dheeraj-Sharma.jpg" alt="" /></a>
                        </figure>
                    </div>
                    <div class="info-box">
                        <div class="inner">
                            ...
                            <span class="designation">
                                Regional Director Business Development ABS Dubai (ME & Africa)
                            </span>
                            <div class="social-box">
                                <button data-toggle="modal" data-target="#Dheeraj" class="btn btn-primary">View More</button>
                            </div>
            ...
            <div class="speaker-block col-lg-3 col-md-6 col-sm-12">
                <div class="inner-box">
                    <div class="image-box">
                        <figure class="image">
                            <a href="Javascript: void(0)"><img src="pics/2024-speakers/vikas-pandey.jpg" alt="" /></a>
                        </figure>
                    </div>
                    <div class="info-box">
                        <div class="inner">
                            ...
                            <span class="designation">
                                Co-Founder , ShipFinex
                            </span>
                            <div class="social-box">
                                <button data-toggle="modal" data-target="#vikas-pandey" class="btn btn-primary">View More</button>
                            </div>
            ...
            <div class="speaker-block col-lg-3 col-md-6 col-sm-12">
                <div class="inner-box">
                    <div class="image-box">
                        <figure class="image">
                            <a href="Javascript: void(0)"><img src="pics/2024-speakers/Michael-Sonder.webp" alt="" /></a>
                        </figure>
                    </div>
                    <div class="info-box">
                        <div class="inner">
                            <h4 class="name">
                                <a href="Javascript: void(0)">Michael Sonderby</a>
                            </h4>
                            <span class="designation">
                                Managing Director and Partner,
                                Head of BCG Digital Ventures China
                            </span>
                            <div class="social-box">
                                <button data-toggle="modal" data-target="#Michael-Sonder" class="btn btn-primary">View More</button>
                            </div>
    ...
    <div class="auto-container">
        ...
        <div class="container">
                ...
                <div class="col-12 col-lg-4 col-md-4">
                    <div class="sponsors-outer">
                        ...
                        <div>
                            <div class="client-block ">
                                <figure class="image-box">
                                    <a href="https://ofco-int.com/" style="" target="_blank"><img src="pics/silver-sponsors/ofco.png" alt="silver sponsor" /></a>
                                </figure>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-12">
                    <div class="sponsors-outer">
                        <h3 style="background: #1d95d2;" class="w-100 text-center">Delegate Bag Sponsor</h3>
                        <div class="row justify-content-center">
                            <!-- sponsor -->
                            <div class="col-12 col-lg-4 col-md-6">
                                <!-- Client Block -->
                                <div class="client-block ">
                                    <figure class="image-box">
                                        <a href="http://www.corrosionindia.org/" target="_blank"><img src="pics/delegate-bag-sponsor/corcon.png" alt="corcon" /></a>
                                    </figure>
                                </div>
                            </div>
                            <!-- end sponsor -->
                    ...
                    <div class="sponsors-outer">
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-12 col-lg-4 col-md-6">
                                <div class="client-block ">
                                    <figure class="image-box">
                                        <a href="javascript:void(0)"><img src="pics/conference-spons/kyra.jpg" alt="IRS-CLASS" /></a>
                                    </figure>
                                </div>
                            </div>
                            <!-- end client -->
                            ...
                            <div class="col-12 col-lg-4 col-md-6">
                                <div class="client-block ">
                                    <figure class="image-box">
                                        <a href="https://www.marcamarine.com/" target="_blank"><img src="pics/conference-spons/mar-ca.webp" alt="mar-ca" /></a>
                                    </figure>
                                </div>
                            </div>
                            <!-- end client -->
    ...
    <div class="auto-container">
                        ...
                        <div class="schedule-block">
                            <div class="inner-box">
                                <div class="inner">
                                    ...
                                    <!-- <h4>
                                        <a href="javascript:void(0)" style="cursor: initial;">Alternative Fuels and ESDs for Tankers</a>
                                    </h4> -->
                                    <!-- <div class="text">
                                        Lorem ipsum dolor sit amet, consectetur adipisicing
                                        elit, sed do eiusmtempor incididunt labore et
        ...
        <div class="row justify-content-center align-items-center">
            <div class="btn-box d-flex justify-content-center">
                <a href="agenda" class="theme-btn btn-style-one" target="_blank"><span class="btn-title">See The Full Schedule Here</span></a>
            </div>
        </div>
        <!-- end btn -->
...
<!-- Modal -->
<div class="modal fade" id="tobias" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header flex-column">
                <h5 style="color: black;font-family: 'Ubuntu', sans-serif;" class="modal-title" id="exampleModalLabel">Tobias Giese</h5>
                <h6 style="color: black;font-family: 'Ubuntu', sans-serif;">
                    Technical Manager<br> LENOL DMCC
                </h6>

            </div>
            <div class="modal-body text-justify">
                <p>
                    Tobias Giese is a well-versed marine technical manager who brings a wealth of experience to the field. Over the course of his career, he has effectively supervised the maintenance and repair of diverse marine vessels, and showcased outstanding leadership in technical capacities.
                </p>
                <p>
                    He commenced his career in the marine lubricants sector as a Technical Service Engineer for LUKOIL Marine Lubricants Germany. Building on his experience in this role, he ascended to the position of Technical Manager, spearheading projects for Lukoil Marine Lubricants in both Germany and Dubai. Prior to assuming the role of Technical Manager at LENOL DMCC, Tobias served as the Technical Superintendent at Liberty Blue Shipmanagement.</p>
                <p>In 2015, Tobias earned his degree in marine engineering from Fachschule für Seefahrt Marine College in Flensburg, Germany, which helped further his journey in the maritime field. Tobias seamlessly blends technical expertise with hands-on experience, making substantial contributions to the advancement of the maritime industry.
...
<!-- Modal -->
<div class="modal fade" id="Nitin" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header flex-column">
                <h5 style="color: black;font-family: 'Ubuntu', sans-serif;" class="modal-title" id="exampleModalLabel">Nitin Mehta</h5>
                <h6 style="color: black;font-family: 'Ubuntu', sans-serif;">
                    COO & Head of Strategy, Lila Global (GMS Group)
                </h6>
            ...
            <div class="modal-body text-justify">
                <p>
                    Nitin Mehta serves as the Chief Operating Officer and Head of Strategy of GMS. He also serves as the Chief Operating
                    Officer of Lila Global, the ship-owning entity of the GMS group.
                    He joined in 2021, and during this period he has led the group through significant revenue and horizontal growth.
                </p>
                <p>
                    Extensive experience in diverse markets with a profound knowledge of finance and proven advisory skills allow Nitin to
                    provide solutions
                    by getting all stakeholders together to achieve common objectives.

                </p>
                <p>
                    Nitin believes in keeping things simple and attributes his success to mutually respectful
                    relationships, which he has built over his extensive career. He is driven to uphold the highest
                    level of ethics, credibility, and transparency through a diverse and holistic range of competencies
                    he has gained over the last 28 years across multiple geographies.
                </p>
                <p>
                    Prior to joining GMS, he was CEO of Tomini Shipping and held several executive positions for a number of banks,
                    including Standard Chartered, Citibank, and Mashreq Bank.
                </p>
...
<!-- end modal -->
<!-- Modal -->
<div class="modal fade" id="Dheeraj" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header flex-column">
                <h5 style="color: black;font-family: 'Ubuntu', sans-serif;" class="modal-title" id="exampleModalLabel">Capt. Dheeraj Sharma</h5>
            ...
            <div class="modal-body text-justify">
                ...
                <p>
                    Dheeraj joined ABS in early 2022. Prior to this, Dheeraj spent almost a decade at the United Arab Chemical
                    Carriers (UACC) as their General Manger/Owners Representative at their head office in Dubai overseeing the
                    daily running of the 26 tankers and office teams in Singapore, Mumbai & Hongkong. Before coming ashore,
                    he sailed for 17 years with NOL Singapore, Kuwait Oil Tankers (KOTC) and World-Wide Shipping as Master on
                    Shell & BP-chartered vessels.

                </p>
                <p>
                    Dheeraj is qualified Master Mariner from the UK Maritime & Coastguard Agency, holds an MBA in Oil and Gas
                    Management and is a Member of the Institute of Chartered Shipbrokers, London. Having worked for shipowners,
                    managers and oil majors in marine operations, safety, commercial and new building departments, Dheeraj brings
                    a wealth of commercial shipping experience and an owner's perspective with him.
                </p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
...
<!-- end modal -->
<!-- Modal -->
<div class="modal fade" id="vikas-pandey" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header flex-column">
                <h5 style="color: black;font-family: 'Ubuntu', sans-serif;" class="modal-title" id="exampleModalLabel">Capt. Vikas Pandey</h5>
                <h6 style="color: black;font-family: 'Ubuntu', sans-serif;">
                    Co-Founder , ShipFinex
                </h6>
...
<!-- end modal -->
<!-- Modal -->
<div class="modal fade" id="Michael-Sonder" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header flex-column">
                <h5 style="color: black;font-family: 'Ubuntu', sans-serif;" class="modal-title" id="exampleModalLabel">Michael Sonderby</h5>
                <h6 style="color: black;font-family: 'Ubuntu', sans-serif;">
                    Managing Director and Partner,
                    Head of BCG Digital Ventures China
                </h6>
            ...
            <div class="modal-body text-justify">
                <p>
                    Michael is a seasoned digital shipping+, logistics-, and eCommerce strategist with a strong passion for identifying, testing, building and investing in disruptive business platforms and above all building high impact teams.
                </p>
                <p>
                    Before joining BCG, Michael was the Venture GM and Board Member for Twill Logistics and the Head of Strategy at eBay, Germany. He also led Strategy and M&A eBay Classifieds Group, Global. Michael is also a startup investor and advisor for several start-ups
                </p>
                <p>
                    Michael holds a MSc Economics and Industrial Relations, London School of Economics, UK as well as a BSc International Business, Copenhagen Business School, DK. He was also an office in the Royal Danish Army.
                </p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
