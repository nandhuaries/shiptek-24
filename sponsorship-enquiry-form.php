                        ...
                        <form action="">
                            <div class="row justify-content-center">
                                <div class="col-lg-4 col-md-6 col-sm-12 p-3">
                                    <input class="border w-100 inp form-control" type="text" placeholder="First Name" required />
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-12 p-3">
                                    <input class="border w-100 inp form-control" type="text" placeholder="Last Name" required />
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-12 p-3">
                                    <input class="border w-100 inp form-control" type="text" placeholder="Phone Number" required />
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-12 p-3">
                                    <input class="border w-100 inp form-control" type="text" placeholder="E-mail" required />
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-12 p-3">
                                    <input class="border w-100 inp form-control" type="text" placeholder="Job Title" required />
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-12 p-3">
                                    <input class="border w-100 inp form-control" type="text" placeholder="Company Name" required />
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-12 p-3">
